...
APluginsCharacter::APluginsCharacter()
{
...
void APluginsCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
...
void APluginsCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	if (FingerIndex == ETouchIndex::Touch1)
	{
		StopJumping();
...
void APluginsCharacter::MoveForward(float Value)
{
...
void APluginsCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
